              ...
              <div className="relative bg-slate-800/50 backdrop-blur-sm p-8 rounded-2xl border border-slate-700">
                ...
                <div className="flex flex-wrap gap-3">
                  {[
                    ...
                    <span
                      key={index}
                      className="px-4 py-2 bg-linear-to-r from-cyan-500/10 to-purple-500/10 border border-cyan-500/30 rounded-full text-cyan-300 text-sm font-medium"
                    >
                      {skill}
                    </span>
                  ))}
          ...
          >
            ...
            <div className="space-y-6">
              {[
                ...
                <div
                  key={index}
                  className="group flex gap-4 p-6 bg-slate-800/30 backdrop-blur-sm rounded-xl border border-slate-700 hover:border-cyan-500/50 transition-all duration-300 hover:scale-105"
                >
