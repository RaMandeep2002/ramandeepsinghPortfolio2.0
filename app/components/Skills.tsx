...
const Skills = () => {
  ...
  const skills: Skill[] = [
    ...
    { name: 'Elementor', proficiency: 60, category: 'Frontend' },
    { name: 'Framer Motion', proficiency: 55, category: 'Frontend' },
    ...
    { name: 'PostgreSQL', proficiency: 55, category: 'Backend' },
    { name: 'Supabase', proficiency: 55, category: 'Backend' },
    { name: 'Clerk', proficiency: 55, category: 'Backend' },
    { name: 'REST APIs', proficiency: 70, category: 'Backend' },
    { name: 'Git', proficiency: 80, category: 'Tools' },
    { name: 'GitHub', proficiency: 80, category: 'Tools' },
    { name: 'Docker', proficiency: 50, category: 'Tools' },
    { name: 'Postman', proficiency: 50, category: 'Tools' },
    { name: 'Vercel', proficiency: 70, category: 'Tools' },
    { name: 'Netlify', proficiency: 60, category: 'Tools' },
    { name: 'Figma', proficiency: 45, category: 'Tools' },
    { name: 'OpenAI API', proficiency: 55, category: 'Tools' },
    { name: 'GitHub Copilot', proficiency: 70, category: 'Tools' },
